...
| Kaynak | İçerik | Durum |
|---|---|---|
| [Başlangıç Rehberi](./baslangic-rehberi.md) | QoreChain ekosistemine yeni başlayanlar için rehber | Aktif |
...
| [Sorun Giderme](./sorun-giderme.md) | Light Node operasyonunda sık karşılaşılan hatalar ve pratik çözümler | Aktif |
...
| Kategori | Rehber |
|---|---|
| Ana Rehber | [Eigenstate 2 Görevleri](./eigenstate-2-gorevleri.md) |
| Sosyal | [Sosyal Görevler](./eigenstate-2-sosyal.md) |
| Analitik | [Analitik Görevler](./eigenstate-2-analitik.md) |
| Geliştirme | [Geliştirme Görevleri](./eigenstate-2-gelistirme.md) |
| Eğitim | [Eğitim Görevleri](./eigenstate-2-egitim.md) |
| Bölgesel | [Bölgesel Görevler](./eigenstate-2-bolgesel.md) |
| On-Chain | [On-Chain Görevler](./eigenstate-2-on-chain.md) |
| Kanıt Gönderimi | [Eigenstate 2 Kanıt Gönderimi](./eigenstate-2-kanit-gonderimi.md) |
| SSS | [Eigenstate 2 SSS](./eigenstate-2-sss.md) |

## Hızlı Başlangıç

Ekosisteme yeni katılanlar önce [Başlangıç Rehberi](./baslangic-rehberi.md) sayfasını inceleyebilir. Light Node çalıştırmak isteyen operatörler [Light Node Operasyonları](./light-node-operasyonlari.md) dokümanını takip edebilir. Genel sorular için [QoreChain Bilgi Bankası](./bilgi-bankasi.md) ve [QoreChain SSS](./sss.md) sayfaları kısa yanıtlar sunar. Yeni kullanıcılar temel kavramlar için [QoreChain Terimler Sözlüğü](./terimler-sozlugu.md) sayfasını da inceleyebilir. Görev süreçleri için [Eigenstate 2 Görevleri](./eigenstate-2-gorevleri.md), kanıt linki soruları için [Kanıt Linki Rehberi](./kanit-linki-rehberi.md) veya [Eigenstate 2 Kanıt Gönderimi](./eigenstate-2-kanit-gonderimi.md) sayfası kullanılabilir. Sorun yaşayanlar için [Sorun Giderme](./sorun-giderme.md) sayfası mevcuttur.
