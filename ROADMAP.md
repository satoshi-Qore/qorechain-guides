# QoreChain Guides Yol Haritası / Roadmap

Bu yol haritası, QoreChain Guides deposunun uzun vadede iki dilli, topluluk odaklı bir QoreChain Academy bilgi merkezine dönüşmesini izlemek için hazırlanmıştır.

This roadmap tracks the long-term evolution of QoreChain Guides into a bilingual, community-driven QoreChain Academy knowledge hub.

## Vizyon / Vision

QoreChain Guides yalnızca tekil rehberlerin toplandığı bir depo olarak değil; kullanıcıların, node operatörlerinin, geliştiricilerin, katkıcıların ve yeni topluluk üyelerinin güvenilir bilgiye ulaşabileceği düzenli bir öğrenme merkezi olarak gelişmelidir.

QoreChain Guides should evolve beyond a collection of individual guides into a structured learning hub where users, node operators, developers, contributors, and new community members can find reliable information.

## Mevcut Odak / Current Focus

| Alan / Area | Hedef / Goal | Durum / Status |
|---|---|---|
| Light Node Operasyonları / Light Node Operations | Kurulum, servis kontrolü, panel erişimi, loglar ve temel sorun giderme adımlarını güncel tutmak / Keep setup, service checks, panel access, logs, and basic troubleshooting current | Aktif / Active |
| Bilgi Bankası / Knowledge Base | QoreChain, Light Node ve stake sorularını kolay bulunur tutmak / Keep common QoreChain, Light Node, and stake questions easy to find | Aktif / Active |
| SSS / FAQ | Topluluk, görev ve Light Node sorularına kısa yanıtlar sunmak / Provide short answers for community, task, and Light Node questions | Aktif / Active |
| Terimler Sözlüğü / Glossary | QoreChain, blokzincir, altyapı ve governance kavramlarını açıklamak / Explain QoreChain, blockchain, infrastructure, and governance terms | Aktif / Active |
| Eigenstate 2 Bilgi Merkezi / Eigenstate 2 Knowledge Base | 149 gözlemlenen görevi kategori rehberleri, kanıt gönderimi ve SSS ile düzenlemek / Organize 149 observed tasks through category guides, proof submission, and FAQ | Aktif / Active |
...
| Faz / Phase | Amaç / Purpose | Çıktılar / Outputs | Durum / Status |
|---|---|---|---|
| Phase 1: Core Guides | Temel topluluk ve Light Node rehberlerini düzenlemek / Organize core community and Light Node guides | Root README, EN/TR landing pages, Light Node pages, FAQ, glossary | Büyük ölçüde tamamlandı / Mostly complete |
...
| Alan / Area | Amaç / Purpose | Öncelik / Priority |
|---|---|---|
| Getting Started | Yeni kullanıcıların ilk adımlarını sadeleştirmek / Simplify first steps for new users | High |
| Light Node Operations | Operatörlere kurulum ve kontrol akışı vermek / Provide setup and verification flow for operators | High |
| Eigenstate 2 Tasks | Görevleri kanıt ve kategori mantığıyla açıklamak / Explain tasks through proof and category structure | High |
| Troubleshooting | Sorunları hızlı teşhis edilebilir hale getirmek / Make issues easier to diagnose | High |
| Proof Submission | Link gerektiren görevlerde topluluk için net yöntem sunmak / Provide clear proof-link methods for link-based review fields | High |
...
- Operatör odaklı adımları kısa ve kontrol edilebilir tutmak.
- Komutları yalnızca açık ve kullanışlı olduklarında eklemek.
- Türkçe ve İngilizce sayfaları yapı olarak uyumlu tutmak.
- Kritik veya değişebilecek ağ kurallarında resmi kaynaklara yönlendirmek.
...
- Keep Turkish and English pages structurally aligned.
- Point users to official sources for critical or changing network rules.
...
|---|---|
| Aktif / Active | Kullanıma hazır ve takip ediliyor / Ready to use and maintained |
| Hazırlanıyor / Preparing | Konu belirlendi ve içerik planlanıyor / Topic is defined and content is being planned |
| Planlandı / Planned | Konu yol haritasında, henüz sayfa yok / Topic is on the roadmap but no page exists yet |
| Gözden Geçirilmeli / Needs Review | İçerik değişen resmi kaynaklara veya güncel ağ durumuna bağlı / Content depends on changing official sources or current network state |

## Bakım Notu / Maintenance Note

Bu yol haritası topluluk ihtiyacı, resmi duyurular, görev yapısı ve QoreChain ekosistemindeki teknik gelişmelere göre güncellenmelidir.

This roadmap should be updated as community needs, official announcements, task structures, and technical developments in the QoreChain ecosystem evolve.
